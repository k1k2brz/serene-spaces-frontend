...
interface ButtonProps {
  children: ReactNode;
  className?: string;
  variant?: 'primary' | 'secondary' | 'outline' | 'small' | 'danger';
  type?: 'button' | 'submit';
 ...
 * @param {'primary' | 'secondary' | 'outline' | 'small' | 'danger'} [props.variant='primary'] 버튼의 스타일을 결정하는 변형 옵션
...
export const Button = ({
  ...
  const variants = {
    ...
    danger: `bg-red-500 text-white hover:bg-red-600 focus:ring-red-500 ${isLoading && 'opacity-50 cursor-not-allowed'}`,
  };
